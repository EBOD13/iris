...
class SpotifyPlayer:
    ...
    def activate_device(self):
        ...
        try:
            ...
            print(f"Activated device: {inactive_device_id}")
            return inactive_device_id
        except spotipy.SpotifyException as e:
            print(f"Error activating device: {e}")
            return None

    def queue_random_tracks(self, count=5):
        try:
    ...
    def play_given_song(self, song_name):
        ...
        if result['tracks']['items']:
            ...
            self.current_track = result['tracks']['items'][0]
            self.play(track_uri)
        else:
    ...
    def play_random_saved_track(self):
        try:
            ...
            print(f"Playing random track: {self.current_track['name']}")
    ...
    def resume_track(self):
        try:
            ...
            if active_device_id:
                ...
                print("Resumed playing track")
            else:
                print("No active device found to resume playback")
