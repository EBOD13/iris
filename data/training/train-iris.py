...
documents = []
ignore_words = ['?', '!']
data_file = open('C:/Users/oleka/OneDrive/Desktop/iris/data/dataset/inputs.json').read() # open and read the json file
...
# Note that the document is the combination between the patterns and intents
